(function() {
  Meteor.Router.beforeRouting = function() {
    ...
    Session.set("selectedQuestionListSubHeaderTab", null);
  }
  ...
  Meteor.Router.add({
    ...
    '/questions': function () {
      Session.set("questionListSortProperty", 'createdAt');
      Session.set("selectedTab", 'listQuestions');
      Session.set("selectedQuestionListSubHeaderTab", 'recent');
      return 'questionList';
    },    
    '/questions/recent': {to: function () {
      Session.set("selectedTab", 'listQuestions');
      Session.set("questionListSortProperty", 'createdAt');
      Session.set("selectedQuestionListSubHeaderTab", 'recent');
      return 'questionList';
    }},
    '/questions/best': {to: function () {
      Session.set("selectedTab", 'listQuestions');
      Session.set("questionListSortProperty", 'votes');
      Session.set("selectedQuestionListSubHeaderTab", 'best');
      return 'questionList';
    }},
